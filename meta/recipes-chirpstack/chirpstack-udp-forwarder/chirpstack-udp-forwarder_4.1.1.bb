...
# SRC_URI += "crate://crates.io/chirpstack-udp-forwarder/4.1.1"
SRC_URI += "git://git@github.com/chirpstack/chirpstack-udp-forwarder.git;protocol=ssh;nobranch=1"
SRCREV = "d50b78a3c6629d13452bd99c570fbeb848f040bf"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
...
SRC_URI += " \
    ...
    crate://crates.io/prometheus/0.13.3 \
...
SUMMARY = "ChirpStack UDP Forwarder for Concentratord, compatible with the Semtech UDP protocol"
