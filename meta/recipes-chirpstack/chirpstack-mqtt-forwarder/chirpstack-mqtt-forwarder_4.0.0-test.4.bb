...
# how to get chirpstack-mqtt-forwarder could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/chirpstack-mqtt-forwarder/4.0.0-test.4"
SRC_URI += "git://git@github.com/chirpstack/chirpstack-mqtt-forwarder.git;protocol=ssh;nobranch=1"
SRCREV = "0c4d44cd025e1959754eb51c712d12df19434e4b"
S = "${WORKDIR}/git"
CARGO_SRC_DIR = ""
PV:append = ".AUTOINC+0c4d44cd02"
...
SRC_URI += " \
    ...
    crate://crates.io/chirpstack_api/4.2.0-test.1 \
...
SUMMARY = "ChirpStack MQTT Forwarder"
...
include chirpstack-mqtt-forwarder-${PV}.inc
include chirpstack-mqtt-forwarder.inc
